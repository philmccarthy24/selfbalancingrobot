...
void setup() {
  ...
  // in uTesla
  cal.mag_hardiron[0] = -35.23;
  cal.mag_hardiron[1] = -35.31;
  cal.mag_hardiron[2] = -41.84;

  // in uTesla
  cal.mag_softiron[0] = 0.963;
  cal.mag_softiron[1] = -0.005;
  cal.mag_softiron[2] = -0.035;  
  cal.mag_softiron[3] = -0.005;
  cal.mag_softiron[4] = 0.967;
  cal.mag_softiron[5] = 0.010;  
  cal.mag_softiron[6] = -0.035;
  cal.mag_softiron[7] = 0.010;
  cal.mag_softiron[8] = 1.076;
  ...
  cal.mag_field = 43.46; // approximate value for locations along the equator
